...
// Todos os styled-components são idênticos ao CreateProject.
// Adicionados apenas: disabled states e ColorSwatch/ColorRow (já existiam no CreateProject/styles.ts).
...
export const DeleteButton = styled.button`
  ...
  border: 1.5px solid ${({ theme }) => theme.colors.error.main};
  border-radius: 12px;
  cursor: pointer;
  background: transparent;
